...
namespace Hayalpc.Dcb.Panel.Internal
{
    public class Program
    {
        ...
        public static IWebHostBuilder CreateHostBuilder(string[] args)
        {
            ...
            var mailConfig = new MailConfigHelper();
            config.GetSection("MailConfig").Bind(mailConfig);

            var webSiteDefinition = new WebSiteDefinitionHelper();
            config.GetSection("WebSiteDefinition").Bind(webSiteDefinition);
